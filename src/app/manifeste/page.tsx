...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = isFr
    ? "Manifeste Aurum | Confidentialité, réflexion guidée et clarté"
    : "Aurum Manifesto | Privacy, guided reflection, and clarity";
  const description = isFr
    ? "Le manifeste d'Aurum : un espace privé, sans publicité, centré sur l'écriture, la clarté et la confidentialité."
    : "The Aurum manifesto: a private, ad-free writing space built around guided reflection, clarity, and trust.";
  ...
  const jsonLd = [
    {
      ...
      description: isFr
        ? "Le manifeste d'Aurum autour de la confidentialité, de l'écriture guidée et de la clarté."
        : "Aurum's manifesto around privacy, guided writing, and clarity.",
      url: pageUrl,
