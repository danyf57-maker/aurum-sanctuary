...
> = {
  fr: {
    ...
    intro:
      "Les présentes Conditions d'Utilisation régissent l'accès à Aurum Diary, disponible sur aurumdiary.com. Elles encadrent l'utilisation du service, les fonctionnalités assistées par IA, les abonnements et les responsabilités de chaque partie.",
    sections: [
      {
        title: "1. Acceptation",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Aurum Diary est un service de réflexion privée assistée par IA. Il aide les utilisateurs à écrire, relire leurs pages, recevoir des reflets guidés, et faire émerger des thèmes ou motifs récurrents dans le temps.",
      ...
      {
        title: "5. Fonctionnalités IA et sorties générées",
        paragraphs: [
          "Lorsque vous demandez un reflet, une analyse, un digest ou une autre fonctionnalité assistée par IA, le texte que vous choisissez de soumettre peut être traité par Aurum et ses prestataires techniques pour générer la sortie demandée.",
          "Les sorties générées par IA peuvent être incomplètes, inexactes, maladroites ou inadaptées à votre situation. Elles sont fournies à titre informationnel et réflexif uniquement.",
        ],
        bullets: [
          "Vous restez responsable de la manière dont vous interprétez et utilisez les sorties générées.",
          "Aurum peut modifier, suspendre ou supprimer des fonctionnalités IA à tout moment.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Le chiffrement côté client actuellement déployé ne doit pas être présenté comme un chiffrement de bout en bout ni comme une garantie d'architecture zero-knowledge ou admin-blind.",
        ],
      },
      {
  ...
  en: {
    ...
    intro:
      "These Terms of Use govern access to Aurum Diary, available at aurumdiary.com. They describe how the service may be used, how AI-powered features are delivered, how subscriptions work, and the responsibilities of each party.",
    sections: [
      {
        title: "1. Acceptance",
        paragraphs: [
          ...
          "These terms apply to your use of the website, web app, sign-up flows, AI-assisted features, and services connected to your account.",
        ],
      },
      {
        title: "2. Service description",
        paragraphs: [
          "Aurum Diary is a private AI-assisted reflection service. It helps users write, revisit pages, receive guided reflections, and surface recurring themes or patterns over time.",
      ...
      },
      {
        ...
        paragraphs: [
          "When you request reflections, analyses, digests, or other AI-powered features, the text you choose to submit may be processed by Aurum and its technical service providers to generate the requested output.",
          "AI-generated output may be incomplete, inaccurate, awkward, or unsuitable for your situation. It is provided for informational and reflective purposes only.",
        ],
        bullets: [
          "You remain responsible for how you interpret and use AI-generated output.",
          "Aurum may change, suspend, or remove AI features at any time.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "The currently deployed client-side protection must not be described as end-to-end encryption or as a guaranteed zero-knowledge or admin-blind architecture.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "To the extent permitted by law, Aurum Diary is provided \"as is\" and \"as available\" without warranties of any kind, express or implied, including availability, uninterrupted service, merchantability, fitness for a particular purpose, or the accuracy of AI-generated output.",
          "To the extent permitted by law, Aurum is not liable for indirect, incidental, special, punitive, or consequential damages, including loss of data, lost profits, business interruption, emotional distress, or decisions made based on AI-generated reflections or analyses.",
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = isFr
    ? "Conditions d'utilisation d'Aurum Diary: service de réflexion privée assistée par IA, abonnements, sécurité, contenu et responsabilités."
    : "Aurum Diary terms of use: AI-assisted private reflection, subscriptions, security, content ownership, and responsibilities.";
