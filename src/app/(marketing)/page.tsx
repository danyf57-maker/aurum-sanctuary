...
export default function Home() {
  ...
  return (
    <main className="bg-[#f7f1ea] text-stone-900">
      <SectionShell className="overflow-hidden pt-8 sm:pt-10 lg:pt-14">
        <div className="relative overflow-hidden rounded-[2rem] border border-stone-200/80 bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.95),_rgba(247,241,234,0.86)_55%,_rgba(236,226,214,0.92))] px-6 py-10 shadow-[0_20px_60px_rgba(120,94,72,0.10)] sm:px-8 sm:py-12 lg:px-14 lg:py-16">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.75fr)] lg:items-end">
            <div className="max-w-3xl">
              <div className="mb-6 inline-flex items-center rounded-full border border-stone-200 bg-white/80 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-stone-600">
            ...
            <div className="rounded-[1.75rem] border border-white/70 bg-white/75 p-5 shadow-[0_18px_40px_rgba(120,94,72,0.10)] backdrop-blur">
              <div className="rounded-[1.5rem] bg-stone-950 px-5 py-6 text-stone-100">
                <p className="text-xs uppercase tracking-[0.22em] text-stone-400">A quieter place to land</p>
      ...
      <SectionShell className="pt-0">
        <div className="grid gap-4 md:grid-cols-3">
          {trustCards.map((card) => (
            <article
              key={card.title}
              className="rounded-[1.5rem] border border-stone-200/80 bg-white/80 p-6 shadow-[0_10px_30px_rgba(120,94,72,0.06)]"
            >
      ...
      <SectionShell>
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-stone-500">Problem recognition</p>
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          {problemCards.map((card) => (
            <article
              key={card.title}
              className="rounded-[1.75rem] border border-stone-200/80 bg-[#fbf7f2] p-6 shadow-[0_12px_30px_rgba(120,94,72,0.05)]"
            >
              ...
              <p className="mt-3 text-base leading-relaxed text-stone-600">{card.body}</p>
            </article>
          ))}
        </div>
      </SectionShell>
      ...
      <SectionShell className="bg-white/60">
        <div className="mx-auto max-w-4xl rounded-[2rem] border border-stone-200/80 bg-white/80 px-6 py-10 text-center shadow-[0_14px_40px_rgba(120,94,72,0.08)] sm:px-10 sm:py-12">
          <h2 className="font-headline mt-4 text-3xl font-semibold tracking-tight text-stone-950 sm:text-5xl">
            Aurum helps you clear what&apos;s heavy, understand what&apos;s recurring, and feel mentally lighter
          </h2>
          <div className="mx-auto mt-6 max-w-3xl space-y-4 text-lg leading-relaxed text-stone-700">
      ...
      <SectionShell id="how-it-works">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          {steps.map((step) => (
            <article
              key={step.step}
              className="rounded-[1.75rem] border border-stone-200/80 bg-white/85 p-6 shadow-[0_12px_30px_rgba(120,94,72,0.06)]"
            >
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-stone-500">{step.step}</p>
      ...
      <SectionShell className="bg-white/60">
        <div className="grid gap-8 rounded-[2rem] border border-stone-200/80 bg-white/80 p-6 shadow-[0_14px_40px_rgba(120,94,72,0.08)] sm:p-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
          <div>
            <h2 className="font-headline mt-4 text-3xl font-semibold tracking-tight text-stone-950 sm:text-5xl">
          ...
          <div className="space-y-4">
            {credibilityPoints.map((point) => (
              <article key={point.title} className="rounded-[1.5rem] border border-stone-200/80 bg-[#fbf7f2] p-5">
      ...
      <SectionShell>
        <div className="grid gap-8 rounded-[2rem] border border-stone-200/80 bg-[linear-gradient(135deg,rgba(255,255,255,0.86),rgba(244,236,226,0.95))] p-6 shadow-[0_14px_40px_rgba(120,94,72,0.08)] sm:p-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
          <div>
            <h2 className="font-headline mt-4 text-3xl font-semibold tracking-tight text-stone-950 sm:text-5xl">
          ...
          <div className="rounded-[1.75rem] border border-white/70 bg-white/75 p-6 shadow-sm">
            ...
            <p className="mt-6 border-t border-stone-200 pt-6 text-base leading-relaxed text-stone-700">
      ...
      <SectionShell className="bg-white/60">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 rounded-[2rem] border border-stone-200/80 bg-white/85 p-4 shadow-[0_12px_30px_rgba(120,94,72,0.06)] sm:p-6">
