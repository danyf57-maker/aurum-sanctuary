  ...
  try {
    ...
    if (!hasPremiumAccess && entryCount >= FREE_ENTRY_LIMIT) {
      ...
      return {
        message: txt(
          locale,
          `Vous avez utilisé vos ${FREE_ENTRY_LIMIT} sujets gratuits. Activez 7 jours offerts pour ouvrir de nouveaux sujets et continuer vos reflets guidés avec Aurum.`,
          `You have used your ${FREE_ENTRY_LIMIT} free topics. Start your 7-day free trial to open new topics and continue your guided reflections with Aurum.`
        ),
