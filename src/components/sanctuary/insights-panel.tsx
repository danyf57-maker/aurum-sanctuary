  ...
  return (
    <section className="rounded-2xl border border-stone-200 bg-white p-4 shadow-sm">
      <div className="flex items-center justify-between gap-3">
        <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-stone-600">Tendances</p>
      ...
      {!patterns ? (
        <div className="mt-3 rounded-xl border border-dashed border-stone-300 bg-stone-50/70 p-4 text-sm text-stone-600">
          Lance une analyse pour voir thèmes récurrents, rythmes d&apos;écriture et évolution émotionnelle.
        </div>
      ) : (
        <div className="mt-3 space-y-3">
          <div>
            <p className="text-xs font-semibold text-stone-700">Thèmes récurrents</p>
          ...
          <div className="grid grid-cols-2 gap-3 text-xs text-stone-600">
            ...
            <div className="rounded-xl border border-stone-200 bg-stone-50 p-3">
              <p className="font-semibold text-stone-700">Tendance émotionnelle</p>
              <p className="mt-1">
