        ...
        <div className="overflow-x-auto">
          ...
          <div className="relative mt-5">
            ...
            {grid.map((row, rowIdx) => (
              <div
                key={rowIdx}
                className="flex items-center gap-[3px] mb-[3px]"
              >
                {/* Day label */}
                  ...
                  return (
                    <div
                      ...
                      className={`
                        ...
                        ${
                          cell.count > 0
                            ? "cursor-pointer hover:ring-2 hover:ring-[#C5A059]/50"
                            : ""
                        }
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-2">
                          <h4 className="line-clamp-1 font-headline text-lg text-stone-900">
                            {issue.title}
                          </h4>
                          {isFavorite && (
                            <Star className="h-4 w-4 shrink-0 fill-[#C5A059] text-[#C5A059]" />
                          )}
                        </div>
