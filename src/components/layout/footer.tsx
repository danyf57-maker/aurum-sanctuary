        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-3 grid grid-cols-2 sm:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><Link href="/legal/terms" className="text-sm text-muted-foreground hover:text-foreground">Conditions d'Utilisation</Link></li>
                <li><Link href="/legal/privacy" className="text-sm text-muted-foreground hover:text-foreground">Politique de Confidentialité</Link></li>
              </ul>
            </div>
             <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li><Link href="/account/data" className="text-sm text-muted-foreground hover:text-foreground">Mes Données</Link></li>
              </ul>
            </div>
          </div>
        </div>
