...
export function Header() {
  ...
  if (isAdminPage) {
    return (
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 dark:border-stone-800 pt-[env(safe-area-inset-top)]">
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 dark:border-stone-800">
      <div className="container flex h-14 max-w-screen-2xl items-center">
        {!isAppPage && (
          <div className="mr-4 hidden md:flex">
            <Link href={to('/')} className="mr-6 flex items-center space-x-2">
        ...
        <div className="flex flex-1 items-center justify-end space-x-2">
          ...
          {isAppPage && (
            <div className="hidden lg:flex items-center gap-4 mr-4">
              {currentSection && (
                <div className="rounded-full border border-stone-200 bg-stone-100/70 px-3 py-1 text-xs font-medium text-stone-700 dark:border-stone-700 dark:bg-stone-900 dark:text-stone-200">
